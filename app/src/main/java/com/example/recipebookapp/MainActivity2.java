...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemModels.add(new ItemModel("김치 볶음밥", "10 Min", R.drawable.food1, 4.5f, 2, 400));
        itemModels.add(new ItemModel("닭 볶음탕", "30 Min", R.drawable.food2, 3.8f, 4, 600));
        itemModels.add(new ItemModel("제육 볶음", "20 Min", R.drawable.food3, 4.2f, 3, 550));
        itemModels.add(new ItemModel("크림 리조또", "15 Min", R.drawable.food4, 3.8f, 2, 700));
        itemModels.add(new ItemModel("고구마 맛탕", "20 Min", R.drawable.food5, 3.8f, 3, 450));
        itemModels.add(new ItemModel("오뎅탕", "10 Min", R.drawable.food6, 3.8f, 2, 300));
